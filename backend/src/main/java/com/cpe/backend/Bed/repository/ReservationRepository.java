...
interface ReservationRepository extends JpaRepository<Reservation, Long> {
    ...
    @Query(value ="SELECT b.BED_ID,b.Price,b.TYPE,r.RESERV_DATE,r.PATIENT_ID,r.RESERVATION_ID FROM BED as b  INNER JOIN RESERVATION as r on b.BED_ID = r.BEDS_ID where PATIENT_ID = :nationalID",
     nativeQuery = true)
